...
% SF: Additional packages that we require
...
% SF: Define corporate colors
% SF: Red
\definecolor{pms2347c}{cmyk}{0.0,1.0,1.0,0.12}
% SF: Dark red
\definecolor{pms1815c}{cmyk}{0.0,1.0,1.0,0.49}
...
\fancyhead[LE,RO]{\includegraphics[height=1cm,width=5cm,keepaspectratio=true]{amd_xilinx_logo}}
\fancyhead[CE,CO]{}
\fancyhead[RE,LO]{$projectname\vspace{0.2\baselineskip}\linebreak\nouppercase\leftmark}
\renewcommand{\headrulewidth}{0.25pt}
\fancyfoot[LE,RO]{\thepage}
\fancyfoot[CE,CO]{ © Copyright 2015 – \the\year{} Advanced Micro Devices, Inc}
...
\begin{titlepage}
\includegraphics[height=4cm,width=8cm,keepaspectratio=true]{amd_xilinx_logo}
\vspace*{4cm}
\begin{center}%
